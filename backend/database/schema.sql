...
CREATE TABLE `restaurant_settings` (
  ...
  `max_reservation_time_hours` int DEFAULT NULL,
  `min_anticipation_hours` int DEFAULT NULL,
  `max_guests_per_reservation` int DEFAULT NULL,
...
-- Dump completed on 2025-12-19  1:10:04
